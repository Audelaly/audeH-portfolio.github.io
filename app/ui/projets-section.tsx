...
const ProjetsSection = () => {
    return (
        <>
            <Head>
                <title>Projets - Aude Halipré</title>
                <meta name="description" content="Voici quelques exemples de projets personnels et scolaires que j'ai pu réaliser durant ma formation ou pendant mon temps libre." />
            </Head>
